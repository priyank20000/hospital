						...
						<div class="card-body">
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="" style="width: 15rem !important;margin-right: 20px;">
										<img  src="{{('../storage/'.$user->image)}}" class="img-fluid" alt="User Image" style="border-radius: 11px;">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name">Dr. {{$user->firstname}}{{$user->lastname}}</h4>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="far fa-money-bill-alt"></i> {{$user->salary}} </li>
										</ul>
									</div>
